...
- live guide 当前显示 97 个 bundled skills、28 个 categories。
- raw catalog 当前结构化提取 70 个 bundled rows、17 个 optional rows，共 28 个 sections。
- raw catalog 头部 sections：github 6 · research 5 · productivity 4 · software-development 4 · apple 3。
